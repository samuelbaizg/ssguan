...
import sys
import time
from ssguan.commons.typeutils import Storage, iters, IterBetter, safestr, safeunicode
from ssguan.commons.funcutils import ThreadedDict
...
_databases = {}
def sqldriver(dburl=None, **params):
...
MongoDriver = pymongo.MongoClient
