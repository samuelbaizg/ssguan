...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: jquploadi18n.dragDropStr,
            abortStr: jquploadi18n.abortStr,
            cancelStr: jquploadi18n.cancelStr,
            deletelStr: jquploadi18n.dragDropStr,
            doneStr: jquploadi18n.doneStr,
            multiDragErrorStr: jquploadi18n.multiDragErrorStr,
            extErrorStr: jquploadi18n.extErrorStr,
            sizeErrorStr: jquploadi18n.sizeErrorStr,
            uploadErrorStr: jquploadi18n.uploadErrorStr,
            maxFileCountErrorStr: jquploadi18n.maxFileCountErrorStr,
            downloadStr:jquploadi18n.downloadStr,
            showQueueDiv:false,
            statusBarWidth:500,
            dragdropWidth:500
        }, options);
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            fileInput.change(function () {
                ...
                form.addClass(group);
                if(feature.fileapi && feature.formdata) // use HTML5 support and
